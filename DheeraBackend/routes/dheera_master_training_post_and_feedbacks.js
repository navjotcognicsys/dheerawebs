...
router.post('/', upload.single('dheera_master_post_test_feedback'), (req, res, next) => {
    ...
    .then((jsonObj)=>{
        ...
        Dheera_master_training_post_feedback_Schema.insertMany(army).then(function(){
            res.status(200).send({
...
router.get('/get/count', async (req, res) =>{
    const userCount = await Dheera_master_training_post_feedback_Schema.countDocuments({})
