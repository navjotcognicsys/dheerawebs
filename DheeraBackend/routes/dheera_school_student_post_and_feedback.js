...
router.post('/', upload.single('dheera_school_student_post_test_feedback'), (req, res, next) => {
    ...
    .then((jsonObj)=>{
        ...
        for(var i = 0;i<jsonObj.length;i++){
            ...
            obj.Are_you_student=jsonObj[i]['19. Are you student'];
        ...
        Dheera_school_student_post_feedback_Schema.insertMany(army).then(function(){
            res.status(200).send({
...
router.get('/get/count', async (req, res) =>{
    const userCount = await Dheera_school_student_post_feedback_Schema.countDocuments({})
