var Dheera_school_teacher_pre_Schema = require('../models/dheera_school_teacher_pre.js')
...
function matchQuestions(items, postItems) {
    ...
    let correctAns = {
        What_would_you_do_if_you_were_subjected_to_violence : "b",
        What_is_the_CHILDLINE_Helpline_number: "c",
        Know_your_RIGHTS_Pick_out_the_ones_you_think_are_applicable_to_women_in_India : "c",
        If_you_like_a_girl_you_see_in_public_is_it_appropriate_to_follow_her_and_repeatedly_try_to_strike_a_conversation_as_is_depicted_in_Bollywood : "b",
        What_are_the_roles_of_an_Active_Bystander : "e",
        To_avoid_problems_women_should_dress_modestly_and_be_submissive_at_work : "a",
        A_couple_have_2_children_a_boy_Raju_and_a_girl_Vidya_The_father_lost_his_job_and_decided_to_stop_Vidya_from_going_to_school_because_of_financial_difficulties_This_is_an_example_of : "a",
        A_car_in_front_of_Rahul_was_driving_slowly_Rahul_joked_with_his_wife_it_must_be_a_lady_driver_Pick_up_the_right_statement : "c",
        In_the_above_example_of_driving_Rahul_is_indulging_in : "c",
        Varun_asked_Varsha_out_for_coffee_in_the_college_canteen_Varsha_refused_What_do_you_think_Varun_can_do_next : "d",
        The_above_scenario_is_a_perfect_example_to_understand_what : "a",
        A_husband_spends_months_completing_a_project_is_stressed_as_he_is_fired_over_a_phone_call_Not_compensated_His_wife_tries_to_find_out_who_he_is_talking_to_and_he_lashes_out_tossing_the_phone_and_hits_his_wife_Is_the_action_justified : "b"
    }
  ...
  if(items.length>0){
    items.forEach(item => {
        ...
        if(item.What_would_you_do_if_you_were_subjected_to_violence[0] === correctAns.What_would_you_do_if_you_were_subjected_to_violence){
            count.q1 += 1;
        }
        if(item.What_is_the_CHILDLINE_Helpline_number[0] === correctAns.What_is_the_CHILDLINE_Helpline_number){
            count.q2 += 1;
        }
        if(item.Know_your_RIGHTS_Pick_out_the_ones_you_think_are_applicable_to_women_in_India[0] === correctAns.Know_your_RIGHTS_Pick_out_the_ones_you_think_are_applicable_to_women_in_India){
            count.q3 += 1;
        }
        if(item.If_you_like_a_girl_you_see_in_public_is_it_appropriate_to_follow_her_and_repeatedly_try_to_strike_a_conversation_as_is_depicted_in_Bollywood[0] === correctAns.If_you_like_a_girl_you_see_in_public_is_it_appropriate_to_follow_her_and_repeatedly_try_to_strike_a_conversation_as_is_depicted_in_Bollywood){
            count.q4 += 1;
        }
        if(item.What_are_the_roles_of_an_Active_Bystander[0] === correctAns.What_are_the_roles_of_an_Active_Bystander){
            count.q5 += 1;
        }
        if(item.To_avoid_problems_women_should_dress_modestly_and_be_submissive_at_work[0] === correctAns.To_avoid_problems_women_should_dress_modestly_and_be_submissive_at_work){
            count.q6 += 1;
        }
        if(item.A_couple_have_2_children_a_boy_Raju_and_a_girl_Vidya_The_father_lost_his_job_and_decided_to_stop_Vidya_from_going_to_school_because_of_financial_difficulties_This_is_an_example_of[0] === correctAns.A_couple_have_2_children_a_boy_Raju_and_a_girl_Vidya_The_father_lost_his_job_and_decided_to_stop_Vidya_from_going_to_school_because_of_financial_difficulties_This_is_an_example_of){
            count.q7 += 1;
        }
        if(item.A_car_in_front_of_Rahul_was_driving_slowly_Rahul_joked_with_his_wife_it_must_be_a_lady_driver_Pick_up_the_right_statement[0] === correctAns.A_car_in_front_of_Rahul_was_driving_slowly_Rahul_joked_with_his_wife_it_must_be_a_lady_driver_Pick_up_the_right_statement){
            count.q8 += 1;
        }
        if(item.In_the_above_example_of_driving_Rahul_is_indulging_in[0] === correctAns.In_the_above_example_of_driving_Rahul_is_indulging_in){
            count.q9 += 1;
        }
        if(item.Varun_asked_Varsha_out_for_coffee_in_the_college_canteen_Varsha_refused_What_do_you_think_Varun_can_do_next[0] === correctAns.Varun_asked_Varsha_out_for_coffee_in_the_college_canteen_Varsha_refused_What_do_you_think_Varun_can_do_next){
             count.q10 += 1;
        }
        if(item.The_above_scenario_is_a_perfect_example_to_understand_what[0] === correctAns.The_above_scenario_is_a_perfect_example_to_understand_what){
            count.q11 += 1;
        }
        if(item.A_husband_spends_months_completing_a_project_is_stressed_as_he_is_fired_over_a_phone_call_Not_compensated_His_wife_tries_to_find_out_who_he_is_talking_to_and_he_lashes_out_tossing_the_phone_and_hits_his_wife_Is_the_action_justified[0] === correctAns.A_husband_spends_months_completing_a_project_is_stressed_as_he_is_fired_over_a_phone_call_Not_compensated_His_wife_tries_to_find_out_who_he_is_talking_to_and_he_lashes_out_tossing_the_phone_and_hits_his_wife_Is_the_action_justified){
            count.q12 += 1;
        }
    })
  }
    ...
    if(postItems.length > 0){
        postItems.forEach(item => {
            // console.log(item)
        //    console.log('user ans : ' , item.What_would_you_do_if_you_were_subjected_to_violence, correctAnsPost.What_would_you_do_if_you_were_subjected_to_violence)
           if(item.What_would_you_do_if_you_were_subjected_to_violence === correctAnsPost.What_would_you_do_if_you_were_subjected_to_violence){
               countPost.q1 += 1;
           }
           if(item.Whats_the_CHILDLINE_number === correctAnsPost.Whats_the_CHILDLINE_number){
               countPost.q2 += 1;
           }
           if(item.Know_your_RIGHTS_Pick_out_the_ones_you_think_are_applicable_to_women_in_India === correctAnsPost.Know_your_RIGHTS_Pick_out_the_ones_you_think_are_applicable_to_women_in_India){
               countPost.q3 += 1;
           }
           if(item.If_you_like_a_girl_you_see_in_public_is_it_appropriate_to_follow_her_and_repeatedly_try_to_strike_a_conversation_as_is_depicted_in_Bollywood === correctAnsPost.If_you_like_a_girl_you_see_in_public_is_it_appropriate_to_follow_her_and_repeatedly_try_to_strike_a_conversation_as_is_depicted_in_Bollywood){
               countPost.q4 += 1;
           }
           if(item.What_are_the_roles_of_an_Active_Bystander === correctAnsPost.What_are_the_roles_of_an_Active_Bystander){
               countPost.q5 += 1;
           }
           if(item.To_avoid_problems_women_should_dress_modestly_and_be_submissive_at_work === correctAnsPost.To_avoid_problems_women_should_dress_modestly_and_be_submissive_at_work){
               countPost.q6 += 1;
           }
           if(item.A_couple_have_2_children_a_boy_Raju_and_a_girl_Vidya_The_father_lost_his_job_and_decided_to_stop_Vidya_from_going_to_school_because_of_financial_difficulties_This_is_an_example_of === correctAnsPost.A_couple_have_2_children_a_boy_Raju_and_a_girl_Vidya_The_father_lost_his_job_and_decided_to_stop_Vidya_from_going_to_school_because_of_financial_difficulties_This_is_an_example_of){
               countPost.q7 += 1;
           }
           if(item.A_car_in_front_of_Rahul_was_driving_slowly_Rahul_joked_with_his_wife_it_must_be_a_lady_driver_Pick_up_the_right_statement === correctAnsPost.A_car_in_front_of_Rahul_was_driving_slowly_Rahul_joked_with_his_wife_it_must_be_a_lady_driver_Pick_up_the_right_statement){
               countPost.q8 += 1;
           }
           if(item.In_the_above_example_of_driving_Rahul_is_indulging_in === correctAnsPost.In_the_above_example_of_driving_Rahul_is_indulging_in){
               countPost.q9 += 1;
           }
           if(item.Varun_asked_Varsha_out_for_coffee_in_the_college_canteen_Varsha_refused_What_do_you_think_Varun_can_do_next === correctAnsPost.Varun_asked_Varsha_out_for_coffee_in_the_college_canteen_Varsha_refused_What_do_you_think_Varun_can_do_next){
                countPost.q10 += 1;
           }
           if(item.The_above_scenario_is_a_perfect_example_to_understand_what === correctAnsPost.The_above_scenario_is_a_perfect_example_to_understand_what){
               countPost.q11 += 1;
           }
           if(item.A_husband_spends_months_completing_a_project_is_stressed_as_he_is_fired_over_a_phone_call_Not_compensated_His_wife_tries_to_find_out_who_he_is_talking_to_and_he_lashes_out_tossing_the_phone_and_hits_his_wife_Is_the_action_justified === correctAnsPost.A_husband_spends_months_completing_a_project_is_stressed_as_he_is_fired_over_a_phone_call_Not_compensated_His_wife_tries_to_find_out_who_he_is_talking_to_and_he_lashes_out_tossing_the_phone_and_hits_his_wife_Is_the_action_justified){
               countPost.q12 += 1;
           }
       })
    }

    console.log(count, countPost)
...
router.get('/questions', (req, res) => {
    Dheera_school_teacher_post_feedback_Schema.find({}, (err, items) => {
        if(err) {
            ...
            Dheera_school_teacher_pre_Schema.find({}, (err, items) => {
                if (err) {
                    console.log(err);
                }
                else {
...
router.get('/dateFilter/:startDate/:endDate', (req, res) => {
    ...
    Dheera_school_teacher_pre_Schema.find({"registration_time":{"$gte": (req.params.startDate), "$lt": (req.params.endDate)}}, (err, items) => {
        if (err) {
            console.log(err);
        }
        else {
...
router.get('/filter/:key/:key1/:key2/:key3', async (req, res) => {
    console.log(req.params.key1)
    Dheera_school_teacher_pre_Schema.find({
        "$and" : [
            {"state" : {$regex:req.params.key}},
            {"select_One" : {$regex:req.params.key1}},
            {"select" : {$regex:req.params.key2}},
            {"school_type" : {$regex:req.params.key3}},
        ]
    }, async (err, items) => {
        if (err) {
            console.log(err);
            ...
            let [dataArr, filteredData] = await findUsersInPostFeedback(items)
...
async function findUsersInPostFeedback(preItems) {
    ...
    for (const item of preItems) {
        ...
        try {
            let found = await Dheera_school_teacher_post_feedback_Schema.findOne({"Username" : item.email })
            if(found){
    ...
    let dataArr = matchQuestions(preItems, filteredUsers)
    console.log(filteredUsers.length)
    return [dataArr, filteredUsers];
}
...
router.post('/', upload.single('dheera_school_teacher_registration_pre'), (req, res, next) => {
    ...
    .then((jsonObj)=>{
        if(compareKeys(jsonObj)){
            ...
            Dheera_school_teacher_pre_Schema.insertMany(army).then(function(){
                res.status(200).send({
...
router.get('/get/count', async (req, res) =>{
    const userCount = await Dheera_school_teacher_pre_Schema.estimatedDocumentCount()
