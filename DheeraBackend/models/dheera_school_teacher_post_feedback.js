...
var dheera_school_teacher_post = new mongoose.Schema({  
    Timestamp:Date,
...
const Dheera_school_teacher_post_feedback_Schema =mongoose.model('Dheera_school_teacher_post_and_feedback',dheera_school_teacher_post); 
module.exports = Dheera_school_teacher_post_feedback_Schema
