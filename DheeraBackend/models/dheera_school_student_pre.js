...
var dheera_school_student_pre = new mongoose.Schema({  
    firstName: String,
    lastName: String,
...
const Dheera_school_student_pre_Schema =mongoose.model('Dheera_school_student_pre',dheera_school_student_pre); 
module.exports = Dheera_school_student_pre_Schema
