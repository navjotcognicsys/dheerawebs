...
var dheera_master_training_pre = new mongoose.Schema({  
    firstName: String,
    lastName: String,
...
// dheera_master_training_pre.clearIndexes({state: 1, are_you_Master_Trainer_or_Trainee : 1})
   
const Dheera_master_training_pre_Schema =mongoose.model('Dheera_master_training_pre',dheera_master_training_pre); 
module.exports = Dheera_master_training_pre_Schema
